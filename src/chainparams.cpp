...
public:
    CMainParams() {
        ...
        // vSeeds.emplace_back("seed-a.bintancoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.bintancointools.com");
        // vSeeds.emplace_back("dnsseed.bintancoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.bintancointools.com");
        // vSeeds.emplace_back("seed-b.bintancoin.loshan.co.uk");
