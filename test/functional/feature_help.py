...
"""Verify that starting bintancoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bintancoin with -h for help text")
        ...
        self.log.info("Start bintancoin with -version for version information")
