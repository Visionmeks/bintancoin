...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bintancoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bintancoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bintancoin transaction") + "\n" +
              "  bintancoin-tx [options] -create [commands]   " + _("Create hex-encoded bintancoin transaction") + "\n" +
              "\n";
